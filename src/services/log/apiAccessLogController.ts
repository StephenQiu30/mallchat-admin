...
export async function addApiAccessLog(
  ...
  return request<API.BaseResponseLogOperationResultVO>('/log/access/add', {
    method: 'POST',
    headers: {
...
export async function deleteApiAccessLog(body: API.LogIdRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLogOperationResultVO>('/log/access/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
