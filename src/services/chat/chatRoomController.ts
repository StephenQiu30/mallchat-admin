...
export async function addChatRoom(body: API.ChatRoomAddRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>('/chat_room/add', {
    method: 'POST',
    headers: {
...
export async function joinChatRoom(
  ...
  params: API.joinChatRoomParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean>('/chat_room/join', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function listUserChatRooms(options?: { [key: string]: any }) {
  return request<API.BaseResponseListChatRoomVO>('/chat_room/list/vo', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function getOrCreatePrivateRoom(
  ...
  return request<API.BaseResponseLong>('/chat_room/private', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
